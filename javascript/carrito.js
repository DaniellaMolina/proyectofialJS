    ...
    $("#cuerpo").append(`
              ...
              <div class="card-body">
                  ...
                  <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                      <button  id="agregar${cake.id}" type="button" onclick="agregarCarrito(${cake.id})" class=" agregbtn btn-dark"> Agregar </button>
                  </div>
              </div>
          </div>
          `);
  ...
  for (let cake of macarons) {
    $("#cuerpo2").append(`
              ...
              <div class="card-body">
                  ...
                  <p class="card-text">$${cake.precio}</p>
                  <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                      <button id="agregar${cake.id}" type="button" onclick="agregarCarrito(${cake.id})" class="agregar btn btn-dark"> Agregar </button>
                  </div>
              </div>
          </div>
          `);
